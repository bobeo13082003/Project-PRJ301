...
public class AddServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            Products products = new Products(name, images, describe, newprice, categories);
            boolean add = dao.insert(products);
            if(add == true){
                request.setAttribute("succes", "Create Product Succesfully");
            }else{
                request.setAttribute("fail", "Cretate Failure");
            }
        } catch (Exception e) {
        }
